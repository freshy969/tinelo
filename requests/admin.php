...
switch ($_POST['action']) {	
	...
	case 'website':
		...
		$siteLanding = $_POST['site_landing'];

		$sitePage = $_POST['site_page'];

		//tutaj ustawic zmiane szablonow

		$mysqli->query("UPDATE config SET name = '$name', email = '$email', photo_review = '$review', title = '$title', description = '$desc', keywords = '$keywords', lang = '$lang', logo = '$logo', email_verification = '$email_verification', free_credits = '$credits', free_premium = '$premium', logo_landing = '$logoL', main_color = '$color', site_landing = '$siteLanding', site_page = '$sitePage'");
